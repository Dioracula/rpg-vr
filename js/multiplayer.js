...
AFRAME.registerComponent('firebase-multiplayer', {
    init: function() {
        this.db = window.realtimeDB; this.playersRef = this.db.ref('players'); this.myId = 'player_' + Math.random().toString(36).substr(2, 9); 
...
AFRAME.registerComponent('gerenciador-respawns', {
    init: function() {
        this.db = window.realtimeDB; this.respawns = {};
...
AFRAME.registerComponent('sistema-inimigo-sync', { 
    ...
    init: function () { 
        ...
        this.dbRef = window.realtimeDB.ref('cenario_inimigos/' + this.data.idBd); this.ultimoTempoTiro = 0; this.ultimoTempoMelee = 0; this.dadosBD = null;
